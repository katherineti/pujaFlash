...
import { Clock, MapPin, Phone, Share2, Tag, Verified } from 'lucide-react';
...
export function RestaurantModal({ campaign }: RestaurantModalProps) {
    ...
    <div className="max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="text-center text-xs text-muted-foreground flex items-center justify-center gap-2">
                ...
                <span>Anuncio verificado • 245 personas han visto esta oferta</span>
            </div>
        </div>
    </div>
  );
